...
class SearchNewsRemoteMediator(
    ...
    override suspend fun load(
        ...
        try {
            ...
            delay(3000)
            val serverSearchResults = response.response.results.drop(1) // drop for testing purposes
            ...
            // The Guardian API returns an error on an empty page, but newsapi.org an empty list
    ...
    override suspend fun initialize(): InitializeAction {
        Timber.d("refreshOnInit = $refreshOnInit")
