...
import com.ravi_100rathiya.mvvmnewsapp.util.networkBoundResource
...
class NewsRepository @Inject constructor(
    ...
    fun getSearchResultsPaged(query: String, refreshOnInit: Boolean): Flow<PagingData<NewsArticle>> =
        Pager(
            ...
            // smaller page size makes it less like that append causes DiffUtil to jump to the next page
